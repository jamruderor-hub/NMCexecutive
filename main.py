...
def main(page: ft.Page):
    ...
    def pindah_menu(nama, sub=""):
        ...
        if halaman_aktif == "dashboard":
            ...
            header = ft.Container(bgcolor="#141a29", padding=20, content=ft.Row([ft.Row([ft.Image(src="icon_android.png", width=30, height=30, fit="contain"), ft.Text("NMC", weight="bold", size=20, color="#3498DB"), ft.Text("Executive", size=20, color="white")], alignment="start", spacing=8), ind_warna], alignment="spaceBetween"))
            ...
            # 2. KONTEN DATA (Bagian ini yang diberikan fitur Scroll)
            konten_scroll = ft.Column([card_kasir, card_bahan_baku, card_produksi, card_top_5, ft.Container(height=10)], scroll="auto", expand=True)
        ...
        # ==========================================
            ...
            header_transaksi = ft.Container(bgcolor="#141A29", padding=20, content=ft.Column([ft.Row([ft.Row([ft.Image(src="icon_android.png", width=25, height=25, fit="contain"), ft.Text("Pusat Data", weight="bold", size=18, color="white")], spacing=10), ind_warna], alignment="spaceBetween")]))
        ...
        # ==========================================
            ...
            header_antrean = ft.Container(bgcolor="#141A29", padding=20, content=ft.Column([ft.Row([ft.Row([ft.Image(src="icon_android.png", width=25, height=25, fit="contain"), ft.Text("Live Yard", weight="bold", size=18, color="white")], spacing=10), ind_warna], alignment="spaceBetween"), ft.Text("Pantau arus kendaraan di dalam pabrik.", color="#BDC3C7", size=12)]))
        ...
        # ==========================================
            ...
            if sub_halaman_aktif == "":
                header_setting = ft.Container(
                    ...
                    content=ft.Column([
                        ft.Row([
                            ft.Image(src="icon_android.png", width=35, height=35, fit="contain"), 
                ...
                konten_about = ft.Container(
                    ...
                    content=ft.Column([
                        ...
                        ft.Image(src="icon_android.png", width=110, height=110, fit="contain"), 
                        ft.Container(height=15), 
                        ...
                        ft.Text(
                            "Sistem pemantauan eksekutif yang dirancang khusus untuk mengelola, mengontrol, dan menganalisis data operasional jembatan timbang secara terpusat dan real-time.", 
                            color="#E0E0E0", 
                            text_align="center", 
                            size=13
                        ), 
